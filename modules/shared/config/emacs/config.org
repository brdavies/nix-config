...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/ben/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/ben/bin" "/profile/bin" "/Users/ben/.npm-packages/bin" "/Users/ben/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
